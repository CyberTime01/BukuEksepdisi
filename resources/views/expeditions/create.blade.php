...
@section('title', 'Tambah Data Ekspedisi Baru')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Nomor Urut Otomatis:</strong> {{ sprintf('%03d/%d', $nextSequentialNumber, $currentYear) }}
                </div>

                <form action="{{ route('expeditions.store') }}" method="POST" id="expeditionForm">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local"
                                   ...
                                   id="received_at"
                                   name="received_at"
                                   value="{{ old('received_at', date('Y-m-d\TH:i')) }}"
                                   required>
                            @error('received_at')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('recipient_name_clear') }}"
                        ...
                        <div class="signature-container">
                            ...
                            <div class="signature-controls mt-2">
                                ...
                                <small class="text-muted ms-3">
                                    ...
                                    Gunakan mouse atau sentuh layar untuk membuat paraf
                                </small>
                            </div>
                        </div>
                        <input type="hidden" id="recipient_signature" name="recipient_signature">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('classification') is-invalid @enderror"
                                ...
                                <option value="Lainnya" {{ old('classification') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror"
                                      ...
                                      name="notes"
                                      rows="3"
                                      placeholder="Catatan tambahan untuk monitoring tindak lanjut...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
